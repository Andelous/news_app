...
class ClienteHttp {
  static final String apiKey = 'd2cc0c891bec4c50ab7038269580edc4';

  static Future<List<Noticia>?> getEverything() async {
...
""";
    ...
    var decodedResponse = jsonDecode(example) as Map;
    ...
    if (status == 'ok') {
      ...
      for (Map noticiaMap in noticiasMap) {
        noticia = Noticia(
          ...
          descripcion: noticiaMap['description'],
